...
return [
    ...
    'goals_description' => 'Επιλέξτε ό,τι σας ταιριάζει και θα ρυθμίσουμε το Posta Studio για εσάς.',
    'goals' => [
        'save_time' => 'Εξοικονόμηση χρόνου δημοσιεύοντας παντού ταυτόχρονα',
        'ai_content' => 'Δημιουργία δημοσιεύσεων με το AI του Posta Studio',
    ...
    'referral_source_description' => 'Αυτό μας βοηθά να καταλάβουμε πώς οι άνθρωποι ανακαλύπτουν το Posta Studio.',
    'referral_source' => [
        'google' => 'Google',
        'x' => 'X (Twitter)',
        'linkedin' => 'LinkedIn',
    ...
    'connect' => [
        ...
        'description' => 'Επίλεξε τουλάχιστον ένα δίκτυο όπου το Posta Studio μπορεί να δημοσιεύει το περιεχόμενό σου.',
