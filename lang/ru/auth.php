...
return [
    ...
    */
    ...
    'flash' => [
        'welcome' => 'Добро пожаловать в Posta Studio!',
        'welcome_trial' => 'Добро пожаловать в Posta Studio! Ваш пробный период начался.',
    ],

    'legal' => 'Продолжая, вы соглашаетесь с нашими <a href="https://postastudios.com/terms" target="_blank">Условиями использования</a> и <a href="https://postastudios.com/privacy" target="_blank">Политикой конфиденциальности</a>.',
