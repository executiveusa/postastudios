...
return [
    ...
    */
    ...
    'flash' => [
        'welcome' => 'Posta Studio へようこそ！',
        'welcome_trial' => 'Posta Studio へようこそ！トライアルが開始されました。',
    ],

    'legal' => '続行すると、<a href="https://postastudios.com/terms" target="_blank">利用規約</a>および<a href="https://postastudios.com/privacy" target="_blank">プライバシーポリシー</a>に同意したものとみなされます。',
