...
return [
    ...
    'workspace' => [
        ...
        'delete_members_warning' => '{1}سيفقد عضو آخر واحد الوصول. الأعضاء الذين ليس لديهم مساحة عمل أخرى في Posta Studio سيُحذف حسابهم نهائيًا.|[2,*]سيفقد :count أعضاء آخرين الوصول. الأعضاء الذين ليس لديهم مساحة عمل أخرى في Posta Studio سيُحذف حسابهم نهائيًا.',
    ...
    'members' => [
        ...
        'errors' => [
            ...
            'email_belongs_to_account' => 'هذا البريد الإلكتروني ينتمي بالفعل إلى حساب Posta Studio آخر. اطلب بريد عمل مخصص بدلاً من ذلك.',
        ],
