...
return [
    ...
    */
    ...
    'flash' => [
        'welcome' => '欢迎使用 Posta Studio！',
        'welcome_trial' => '欢迎使用 Posta Studio！你的试用已开始。',
    ],

    'legal' => '继续即表示你同意我们的<a href="https://postastudios.com/terms" target="_blank">服务条款</a>和<a href="https://postastudios.com/privacy" target="_blank">隐私政策</a>。',
