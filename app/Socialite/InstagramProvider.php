...
class InstagramProvider extends AbstractProvider implements ProviderInterface
{
    ...
    {
        $response = $this->getHttpClient()->get(config('postastudio.platforms.instagram.graph_api').'/me', [
    ...
    protected function exchangeForLongLivedToken(array $data): array
    {
        ...
        $response = $this->getHttpClient()->get(config('postastudio.platforms.instagram.auth_api').'/access_token', [
            RequestOptions::QUERY => [
