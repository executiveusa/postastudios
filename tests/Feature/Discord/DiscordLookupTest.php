...
test('does not hide channels when the bot role lookup is unavailable', function () {
    ...
    Http::fake([
        ...
        config('postastudio.platforms.discord.api').'/guilds/111222333/members/999000111' => Http::response(['message' => 'Missing Access', 'code' => 50001], 403),
    ]);
...
test('returns mention targets: specials, roles and members', function () {
    Http::fake([
        ...
        config('postastudio.platforms.discord.api').'/guilds/111222333/members/search*' => Http::response([
...
test('degrades to specials only when the roles/members lookup fails', function () {
    ...
    Http::fake([
        config('postastudio.platforms.discord.api').'/guilds/111222333/roles' => Http::response(['message' => 'Missing Access', 'code' => 50001], 403),
        config('postastudio.platforms.discord.api').'/guilds/111222333/members/search*' => Http::response(['message' => 'Missing Access', 'code' => 50001], 403),
    ]);
