...
<template>
  <DrawerPortal>
    ...
    <DrawerContent
      ...
      :class="cn(
        'group/drawer-content bg-card fixed z-50 flex h-auto flex-col border-border shadow-xl',
    ...
    >
      <div class="bg-muted-foreground/25 mx-auto mt-4 hidden h-1.5 w-12 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
      <slot />
    </DrawerContent>
  </DrawerPortal>
</template>
